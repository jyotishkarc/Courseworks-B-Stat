...
par(mfrow=c(1,3))
hist(M,col='yellow',probability = TRUE,breaks=30,main="Histogram of Sample Mean")
plot(est_density,0.48,0.52,col='darkblue',add=TRUE,lwd=3)
hist(T,col='yellow',probability = TRUE,breaks=30,main="Histogram of Sample T")
plot(est_density1,-3,3,col='darkblue',add=TRUE,lwd=3)
hist(V,col='yellow',probability = TRUE,breaks=30,main="Histogram of Sample Variance")
par(new=TRUE)
